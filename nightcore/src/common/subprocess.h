  ...
  namespace uv {
    ...
    class Subprocess : public Base {
     public:
      ...
      explicit Subprocess(std::string_view cmd, size_t max_stdout_size = kDefaultMaxStdoutSize,
      ...
      bool Start(uv_loop_t* uv_loop, utils::BufferPool* read_buffer_pool, ExitCallback exit_callback);
